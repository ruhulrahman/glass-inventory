  ...
  <q-card class="bg-primary text-white no-shadow wait_me" bordered>
      <q-card-section class="row q-pa-sm">
        <q-item class="full-width">
          <q-item-section>
            <q-item-label class="text-h6 text-weight-bolder" lines="1">Product Pricing History</q-item-label>
          </q-item-section>
          <q-item-section side>
      ...
      <q-card-section class="q-pa-sm ">
        <q-table flat bordered class="no-shadow wait_me" :rows="tableRow" :columns="columns"
