    ...
    <q-form @submit="saveData">
      <q-card-section class="row q-pa-sm">
        <q-item class="full-width">
          <q-item-section>
            <q-item-label class="text-h6 text-weight-bolder" lines="1">{{ submitForm.id ? $t('update_unit') : $t('add_new_unit') }}</q-item-label>
          </q-item-section>
          <q-item-section side>
      ...
      <q-card-section class="q-pa-sm ">
        <q-list class="row">
          ...
          <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <q-item-section>
              <q-input dark color="white" dense v-model="submitForm.name" :label="$t('unit_name')"
